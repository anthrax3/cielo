        ...
        if ( is_int( $parcels ) && ( $parcels >= 1 ) ) {
            ...
            if (  !is_null( $creditCard ) ) {
                if ( $creditCard == CreditCard::VISA || $creditCard == CreditCard::MASTER_CARD || $creditCard == CreditCard::ELO ||
                     $creditCard == CreditCard::AMERICAN_EXPRESS || $creditCard == CreditCard::DINERS_CLUB || $creditCard == CreditCard::DISCOVER ||
                     $creditCard == CreditCard::JCB || $creditCard == CreditCard::AURA ) {
