 ...
 * @li  5 - Quando o portador autenticou-se com sucesso. (5 = visa , 2 = Mastercard, Aura = n/d e Demais = n/d)
 * @li  6 - Quando o emissor não forneceu mecanismos de autenticação. (6 = visa , 1 = Mastercard, Aura = n/d e Demais = n/d)
 * @li  7 - Quando o portador não se autenticou ou a loja optou por não submeter à autenticação. (7 = visa , 0 = Mastercard, Aura = 0 e Demais = 7)
 * @ingroup     Cielo
 * @class       ECI
 */
final class ECI {
     ...
     * @see     CreditCard::VISA
     * @see     CreditCard::AMERICAN_EXPRESS
     * @see     CreditCard::DINERS_CLUB
     * @see     CreditCard::DISCOVER
     * @see     CreditCard::JCB
     * @see     CreditCard::AURA
        ...
        if ( $flag == CreditCard::VISA || 
            ...
            switch ( $indicator ) {
                case ECI::AUTHENTICATED :
                    return $flag == CreditCard::VISA ? 5 : CreditCard::MASTER_CARD ? 2 : 0 ;
                case ECI::WITHOUT_AUTHENTICATION :
                    return $flag == CreditCard::VISA ? 6 : CreditCard::MASTER_CARD ? 1 : 0;
